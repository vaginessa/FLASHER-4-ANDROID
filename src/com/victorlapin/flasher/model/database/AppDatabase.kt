    ...
    companion object {
        val MIGRATION_1_2 = object : Migration(1, 2) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL(
                    "create table commands_temp (id INTEGER PRIMARY KEY AUTOINCREMENT, " +
                            "type INTEGER NOT NULL, arg1 TEXT, arg2 TEXT, chain_id INTEGER NOT NULL, " +
                            "foreign key (chain_id) references chains(id))"
                )
                db.execSQL(
                    "insert into commands_temp (id, type, arg1, arg2, chain_id) " +
        ...
        val MIGRATION_2_3 = object : Migration(2, 3) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL(
                    "insert into commands_temp (id, type, arg1, arg2, chain_id, order_number) " +
