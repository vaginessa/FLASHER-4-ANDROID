...
/** @author Aidan Follestad (afollestad), modified by Victor Lapin */
public class FolderChooserDialog extends DialogFragment implements MaterialDialog.ListCallback {
    ...
    public static class Builder implements Serializable {
        ...
        @Nullable
        transient FolderCallback callback;
        ...
        @NonNull
        public Builder callback(FolderCallback folderCallback) {
